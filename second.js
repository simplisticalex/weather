...
console.log(conditions);
    ...
    form.onsubmit = function (event) {
        ...
        const smallImgPath = './pictures/' + (data.forecast.forecastday[1].hour[0].is_day ? 'day' : 'night') + '/' + formatConditionText(data.forecast.forecastday[1].hour[0].condition.text) + '.png';
        const smallImgPath2 = './pictures/' + (data.forecast.forecastday[1].hour[3].is_day ? 'day' : 'night') + '/' + formatConditionText(data.forecast.forecastday[1].hour[3].condition.text) + '.png';
        const smallImgPath3 = './pictures/' + (data.forecast.forecastday[1].hour[6].is_day ? 'day' : 'night') + '/' + formatConditionText(data.forecast.forecastday[1].hour[6].condition.text) + '.png';
        const smallImgPath4 = './pictures/' + (data.forecast.forecastday[1].hour[9].is_day ? 'day' : 'night') + '/' + formatConditionText(data.forecast.forecastday[1].hour[9].condition.text) + '.png';
        const smallImgPath5 = './pictures/' + (data.forecast.forecastday[1].hour[12].is_day ? 'day' : 'night') + '/' + formatConditionText(data.forecast.forecastday[1].hour[12].condition.text) + '.png';
        const smallImgPath6 = './pictures/' + (data.forecast.forecastday[1].hour[15].is_day ? 'day' : 'night') + '/' + formatConditionText(data.forecast.forecastday[1].hour[15].condition.text) + '.png';
        const smallImgPath7 = './pictures/' + (data.forecast.forecastday[1].hour[18].is_day ? 'day' : 'night') + '/' + formatConditionText(data.forecast.forecastday[1].hour[18].condition.text) + '.png';
        const smallImgPath8 = './pictures/' + (data.forecast.forecastday[1].hour[21].is_day ? 'day' : 'night') + '/' + formatConditionText(data.forecast.forecastday[1].hour[21].condition.text) + '.png';
        ...
        <div id="flex-container">
             <div id="perviy">
                 <div class="card">
                     <div class="card-time0">${formatDate(data.forecast.forecastday[0].date)}</div>
             ...
             <div id="vtoroy">
                 <div class="card">
                     <div class="card-time2">${formatDate(data.forecast.forecastday[1].date)}</div>
                     <div class="card-temp">${data.forecast.forecastday[1].day.maxtemp_c}°C</div>
             ...
             <div id="tretiy">
                 <div class="card">
                     <div class="card-time">${formatDate(data.forecast.forecastday[2].date)}</div>
                     <div class="card-temp">${data.forecast.forecastday[2].day.maxtemp_c}°C</div>
